...
class MessageController {
    ...
    func subscribeToMessageNotifications(completion: @escaping ((Error?) -> Void) = {_ in }) {
        cloudKitManager.subscribeToCreationOfRecords(ofType: Message.recordType) { (error: Error?) in
